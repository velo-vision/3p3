...
final class Kirki_Fonts_Google {
	...
	/**
	 * This is added by Eram theme to force wanted varients
	 */
	private function eram_add_varients()
	{
		foreach ( $this->fonts as $font => $variants )
		{
			$this->fonts[$font][] = '400';
			$this->fonts[$font][] = 'regular';
			$this->fonts[$font][] = 'italic';
			$this->fonts[$font][] = '700';
			$this->fonts[$font] = array_unique($this->fonts[$font]);
		}
	}
}
