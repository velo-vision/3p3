        ...
        animateIcons:function(){
            ...
            if (self.animMode=='show'){
                ...
                self.$liItems.each(function(i){
                    var $this=$(this);
                    $this.velocity({translateX: multiplier * 35 * (i+1)  },{duration:250,delay:i*40,easing:[ .36,.79,.69,1.22 ],complete:function(){
    ...
    var sideHeader={
        ...
        sideAnimate:function(){
            ...
            if ( self.menuOpenFlg){
                ...
                self.$animationStaggers.velocity("transition.slideLeftOut",{delay:150,duration:100,stagger:10,backwards: true,display:"block",visibility:"hidden", easing:"easeOut",complete:function(){
                    self.$content.hide();
                    self.inAnimation=false;
                }});
            }
                ...
                self.$animationStaggers.velocity("transition.slideLeftIn",{delay:200,duration:300,stagger:80,display:"block",visibility:"visible",complete:function(){
