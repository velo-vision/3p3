...
<?php if ($archive_cover != '') {?>
  ...
  <?php }?>
<?php }?>
<div class="em-blog-wrapper layout-minimal <?php echo $has_sidebar?'with-sidebar':'no-sidebar';?>">
  <?php $header_class .= $has_sidebar ? ' layout-center' : ' layout-side';?>

  <?php if (isset($show_title) ? $show_title : false) {?>
    <div class="blog-header page-head <?php echo $header_class; ?>" data-img-src="<?php echo $archive_cover; ?>" data-parallax-mode="<?php echo $header_parallax_mode; ?>" style="<?php echo $inline_styles?>">
          ...
          <h1 class="title">
            <?php if (is_archive()) {?>
              <span class="upper-title">
                <?php echo esc_html__('Archive for', 'eram');?>
  ...
  <div class="blog-contents">
    <div class="em-blog-posts">
      <?php get_template_part('partials/blog/loop','minimal');?>
